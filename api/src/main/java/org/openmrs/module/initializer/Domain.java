...
public enum Domain {
	...
	CONCEPT_CLASSES(10, "conceptclasses"),
	CONCEPTS(11, "concepts"),
	PROGRAMS(12, "programs"),
	PROGRAM_WORKFLOWS(13, "programworkflows"),
	PROGRAM_WORKFLOW_STATES(14, "programworkflowstates"),
	PERSON_ATTRIBUTE_TYPES(15, "personattributetypes"),
	IDENTIFIER_SOURCES(16, "idgen"),
	DRUGS(17, "drugs"),
	ORDER_FREQUENCIES(18, "orderfrequencies"),
	ORDER_TYPES(19, "ordertypes"),
	APPOINTMENTS_SPECIALITIES(20, "appointmentsspecialities"),
	APPOINTMENTS_SERVICES_DEFINITIONS(21, "appointmentsservicesdefinitions"),
	DATAFILTER_MAPPINGS(22, "datafiltermappings"),
	METADATA_TERM_MAPPINGS(23, "metadatatermmappings"),
