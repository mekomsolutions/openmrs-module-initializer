...
#### Version 2.5.1
* Enhanced Validator so it's usable in a Maven plugin like is done with the [openmrs-packager-maven-plugin 1.5.0](https://github.com/openmrs/openmrs-contrib-packager-maven-plugin)
