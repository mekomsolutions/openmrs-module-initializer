...
2. [Generic JSON key-values (JSON files)](readme/jsonkeyvalues.md)
3. [Metadata Sharing Packages (ZIP files)](readme/mds.md)
4. [Visit Types (CSV files)](readme/visittypes.md)
5. [Patient Identifier Types (CSV files)](readme/pit.md)
6. [Relationship Types (CSV files)](readme/relationshiptypes.md)
7. [Location Tags (CSV files)](readme/loctags.md)
8. [Privileges (CSV files)](readme/priv.md)
9. [Encounter Types (CSV files)](readme/et.md)
10. [Encounter Roles (CSV files)](readme/encounterroles.md)
11. [Roles (CSV files)](readme/roles.md)
12. [Global Properties (XML files)](readme/globalproperties.md)
13. [Attribute Types (CSV files)](readme/atttypes.md)
14. [Provider Roles (CSV files)](readme/providerroles.md)
15. [Locations (CSV files)](readme/loc.md)
16. [Bahmni Forms (JSON Files)](readme/bahmniforms.md)
17. [Concept Classes (CSV files)](readme/conceptclasses.md)
18. [Concept Sources (CSV files)](readme/conceptsources.md)
19. [Concepts (CSV files)](readme/concepts.md)
20. [Programs (CSV files)](readme/prog.md)
21. [Program Worklows (CSV files)](readme/prog.md)
22. [Program Worklow States (CSV files)](readme/prog.md)
23. [Person Attribute Types (CSV files)](readme/pat.md)
24. [Identifier Sources (CSV files)](readme/idgen.md)
25. [Autogeneration Options (CSV files)](readme/autogenerationoptions.md)
26. [Drugs (CSV files)](readme/drugs.md)
27. [Order Frequencies (CSV files)](readme/freqs.md)
28. [Order Types (CSV files)](readme/ordertypes.md)
29. [Bahmni Appointment Specialities (CSV files)](readme/appointmentspecialities.md)
30. [Bahmni Appointment Service Definitions (CSV files)](readme/appointmentservices.md#domain-appointmentservicedefinitions)
31. [Bahmni Appointment Service Types (CSV files)](readme/appointmentservices.md#domain-appointmentservicetypes)
32. [Data Filter Entity-Basis Mappings (CSV files)](readme/datafiltermappings.md)
33. [Metadata Sets (CSV files)](readme/mdm.md#domain-metadatasets)
34. [Metadata Set Members (CSV files)](readme/mdm.md#domain-metadatasetmembers)
35. [Metadata Term Mappings (CSV files)](readme/mdm.md#domain-metadatatermmappings)
36. [HTML Forms (XML files)](readme/htmlforms.md)
